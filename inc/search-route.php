<?php
  ...
  function universitySearchResults($data) {
        ...
        if ($relatedCampuses) {
          foreach($relatedCampuses as $campus) {
            array_push($results['campuses'], array(
              'title' => get_the_title($campus), // specific title we want to get is from campus, not program
    ...
    if ($results['programs']) {
      ...
      // query to establish relationship between programs and other CPTS (i.e profs) when searching
